        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                    ...
                    // if(isset($_POST['DIST']) && $_POST['DIST'] != "All" && $_POST['Block'] == "All") {
                    // $Dis = $_POST['DIST'];
                    // $query5 = "SELECT * FROM `user` WHERE `district`= '$Dis'";
                    // }
                    // elseif ( isset($_POST['Block']) && $_POST['DIST'] != "All" && $_POST['Block'] != "All" && $_POST['Village'] == "All") {
                    // $Dis = $_POST['DIST'];
                    // $Bl = $_POST['Block'];
                    ...
                    foreach ($data as $row) {
                        ...
                        // fetching all data according to login user from json file and database-table
                    ...
                    // if (isset($_POST['username'])) {
                      ...
                      // if ($act) {
                        // if (isset($_POST['Activity'])) {
                          ...
                          // $query55 = "SELECT * FROM `user` WHERE `username`= '$EMP_NAME' AND `district`='  $Dis'";
                          // $result55 = mysqli_query($conn, $query55);
                          if(isset($_POST['Activity'])  && $_POST['Activity'] != "All" && $_POST['Application'] = "Application") {
                        $file = "JSON PC/" . $_POST['username'] . ".json";
                        $data = file_get_contents($file);
                        $data = json_decode($data, true);
                        // if ($result55) {
                        //   $total5 = mysqli_num_rows($result55);
                          $count = 1;
                          if ($data != 0) {
                            foreach ($data as $row) {
