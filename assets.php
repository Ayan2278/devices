                    ...
                    <form method="post" action="assets.php" id="myform">
                        <div class="card-body row">
                            <div class="form-group col-lg-3">
                                ...
                                <select name="school_name" ng-model="school_name" style="width: 100%"
                                    class="form-control">
                                    <option value="">Please Select</option>
                                    <option ng-repeat="users in users " value="{{users.school_name}}">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <select style="width: 100%" name="username" ng-model="username" class="form-control">
                                    <option value="">Please Select</option>
                                    <option ng-repeat="users in users | filter:school_name " ng-show="school_name!=''"
                                        value="{{users.username}}">{{users.username}}</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <select class="form-control " style="width: 100%" name='pc' ng-model="pc">
                                    <option value="">Please Select</option>
                                    <option ng-repeat="users in users | filter:username | filter:school_name"
                                        ng-show="school_name!='' && username!='' " value="{{users.pc_sr}}">
                                        {{users.pc_sr}}</option>
                                </select>
                            </div>
