...
if (isset($_GET['id'])) {
  ...
  if ($row['live_status'] == 'false' && isset($_POST['btnLS']) && $_POST['btnLS'] == 'btnLSD' || $row['live_status'] == '') {
    $qryT = "UPDATE `login` SET `live_status`='true' WHERE `id` = '$id'";
  } else if ($row['live_status'] == 'true' && isset($_POST['btnLS']) && $_POST['btnLS'] == 'btnLSE' || $row['live_status'] == '') {
