                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" name="village" ng-model="village" id="">
                                    <option value="">Select</option>
                                    <option ng-repeat="users in users | filter: {district : srchDistrict} | filter: {block : srchBlock}" value="{{users.village}}">{{users.village}}
                                    </option>
                                </select>
                            </div>
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" name="school_name" ng-model="school_name" id="">
                                    <option value="">Select</option>
                                    <option ng-repeat="users in users | filter: {district : srchDistrict} | filter: {block : srchBlock} | filter:{village:village} " value="{{users.school_name}}">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select class="form-control" name="pc_sr" ng-model="pc_sr" id="">
                                    <option value="">Select</option>
                                    <option ng-repeat="users in users | filter: {district : srchDistrict} | filter: {block : srchBlock} | filter:{village:village} | filter:{school_name:school_name}" value="{{users.pc_sr}}">{{users.pc_sr}}</option>
                                </select>
                            </div>
