                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-lg-2">
                                ...
                                <select name="srchBlock" ng-model="srchBlock" style="width:100%;" class="form-control ">
                                    <option value="">Select</option>
                                    <option ng-repeat="users in districts | filter: {district : srchDistrict}" value="{{users.block}}">{{users.block}}
                                    </option>
                                </select>
                            </div>
                        <div class="form-group col-lg-2">
                            ...
                            <option Value="">Select</option>
                            <option ng-repeat="users in districts | filter: {district : srchDistrict} | filter: {block : srchBlock}" value="{{users.village}}">{{users.village}}</option>
                            </select>
                        </div>
                        <div class="form-group col-lg-2">
                            ...
                            <select class="form-control  " ng-model="PC" style="width: 100%" name='PC'>
                                <option value="">Select</option>
                                <option ng-repeat="users in districts | filter: {district : srchDistrict} | filter: {block : srchBlock} | filter :{village : Village}" value="{{users.pc_sr}}">{{users.pc_sr}}</option>
                            </select>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <table id="example2" class="  table-striped table-bordered table-hover"
                                ...
                                <tbody ng-controller="useCtrl">
                                    <tr ng-repeat="user in users | filter: {district: srchDistrict} | filter: {block: srchBlock} | filter: {village: Village} | filter: {pc_sr : PC}" style="text-align:center; height:41px; font-size:15px;">
                                        <td>{{user.Sr}}</td>
                                        <td>{{user.pc_sr}}</td>
                                        <td>{{user.Date}}</td>
                                        <td>{{user.Start_time}}</td>
                                        <td><small class="badge badge-success" ng-show="user.End_time == 'Running'">{{user.End_time}}</small>
                                            <span ng-show="user.End_time != 'Running'">{{user.End_time}}</span></td>
                                        <td>{{user.Duration}}</td>
                                        </tr>
                                    </tbody>
                            </table>
